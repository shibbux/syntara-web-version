...
function takeCommand(message){
   voice.style.display="none"
    ...
    if(message.includes("hello")||message.includes("hey")){
        speak("hello sir I am syntara,what can i help you?")
    }
      ...
      speak(time)
        ...
        let finalText="this is what i found on internet regarding" + message.replace("syntara","") || message.replace("syntara","")
        speak(finalText)
